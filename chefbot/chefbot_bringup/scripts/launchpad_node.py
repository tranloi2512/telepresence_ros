...
#######################################################################################################################
#Speed subscriber
		self._left_motor_speed = rospy.Subscriber('lwheel_vtarget',Float32,self._Update_Left_Speed)

		self._right_motor_speed = rospy.Subscriber('rwheel_vtarget',Float32,self._Update_Right_Speed)


#######################################################################################################################
	def _Update_Left_Speed(self, left_speed):

		self._left_wheel_speed_ = int(60*(-59.42)*left_speed.data)
		#self._left_wheel_speed_ = int(564)

		rospy.loginfo(left_speed.data)

		if self._left_wheel_speed_ < 0: self._left_wheel_speed_=2000-self._left_wheel_speed_
		if self._right_wheel_speed_ < 0: self._right_wheel_speed_=2000-self._right_wheel_speed_

		speed_message = "s %d %d " %(int(self._left_wheel_speed_),int(self._right_wheel_speed_))
		#speed_left_message = "s %d %d " %(int(self._left_wheel_speed_))
...
#######################################################################################################################################################3
	...
	def _Update_Right_Speed(self, right_speed):
		...
		self._right_wheel_speed_ = int(60*(-59.42)*right_speed.data)
		#self._right_wheel_speed_ = int(32)
